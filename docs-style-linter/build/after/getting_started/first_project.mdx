...
Name your project `meilisearch-quick-start` and select the region closest to you, then click "Create project":
...
Creating your project might take a few minutes. Check the project list to follow its status. Once the project is ready, click its name to go to the project overview page:
...
First, click the indexes tab in the project page menu:
...
This leads you to the index listing. Click "New index":
...
Write `movies` in the name field and click "Create Index":
...
Meilisearch Cloud will ask you for your dataset. To follow along, use this <a href="https://www.meilisearch.com/docs/assets/datasets/movies.json" download="movies.json">list of movies</a>. Download the file to your computer, drag and drop it into the indicated area, then click "Import documents":
...
Meilisearch Cloud will index your documents. This may take a moment. Click "See index list" and wait. Once it is done, click "Settings" to visit the index overview:
...
Click the project name on the breadcrumb menu to return to the project overview:
...
Meilisearch Cloud comes with a search preview interface. Click "Search preview" to access it:
