...
[docs-scraper](https://github.com/meilisearch/docs-scraper) is a scraper tool that automatically reads the content of your website and stores it into a Meilisearch index.

<Note>
docs-scraper is in reduced-maintenance mode. If you're on [Meilisearch Cloud](https://cloud.meilisearch.com), consider using the built-in crawler instead. For a self-hosted alternative, see [Scrapix](https://github.com/meilisearch/scrapix).
</Note>
...
`lvlX` selectors should use the standard title tags like `h1`, `h2`, `h3`, and so on. You can also use static classes. Set a unique `id` or `name` attribute to these elements.
...
<Tip>
Check the [docs-scraper documentation](https://github.com/meilisearch/docs-scraper#readme) for the full list of configuration options.
</Tip>
...
<Note>
For other installation methods, refer to the [docs-scraper repository](https://github.com/meilisearch/docs-scraper#run-the-scraper.
</Note>
...
_More about [Meilisearch security](/resources/self_hosting/security/basic_security)._
