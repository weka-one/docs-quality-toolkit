...
Select your project, then click **Deploy**. Once deployment is complete, go back to your project's dashboard.

### Add the Meilisearch integration

Go to the project settings tab and click **Integrations** on the sidebar menu to the left of your screen.
...
Search for the [Meilisearch integration](https://vercel.com/integrations/meilisearch-cloud) in the search bar. Click the **Add integration** button.
...
Click **Continue**. Vercel will display a list with the permissions the integration needs to work properly. Review it, then click **Add Integration**.
...
<Frame>
  <img src="/assets/images/vercel/05.create-a-meilisearch-cloud-project-form.png" alt="Meilisearch Cloud form to create a project complete, with 'search-app' as the project's name and 'Frankfurt' as the region" />
</Frame>

Once you click **Create project**, you should see the following message: "Your Meilisearch + Vercel integration is one click away from being completed." Click "Finish the Vercel integration setup". Meilisearch will then redirect you back to the Vercel integration page.
...
<Frame>
  <img src="/assets/images/vercel/08.meilisearch-cloud-dashboard.png" alt="Meilisearch Cloud dashboard: overview of the 'search-app' project" />
</Frame>
