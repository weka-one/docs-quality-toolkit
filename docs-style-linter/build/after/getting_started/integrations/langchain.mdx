...
description: Use Meilisearch as a LangChain vector store for semantic search with OpenAI embeddings.
---
...
Using Meilisearch as a LangChain vector store lets you load documents and search for them in different ways:
