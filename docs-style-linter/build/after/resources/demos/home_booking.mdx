...
- **Chat search**: Describe your ideal stay in plain language (for example, "Find me a family-friendly beach house in Europe under $300/night") and get relevant property results with matching keywords highlighted.
...
<CardGroup cols={2}>
  ...
  <Card title="Chat route docs" icon="message-bot" href="/capabilities/agentic_search/advanced/chats_api">
