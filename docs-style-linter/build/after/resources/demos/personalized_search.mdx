...
- **Editable user profile**: Modify the user preference prompt (for example, "The user prefers genres: Action, Adventure, Sci-Fi") and see results rerank instantly.
...
- **Transparent reranking**: Compare personalized versus non-personalized results to understand the impact of context on relevancy.
