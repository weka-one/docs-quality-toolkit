...
|---|---|---|
| **Latin** (English, French, Spanish, Italian, Portuguese, and so on.) | CamelCase segmentation | Decomposition, lowercase, nonspacing-marks removal |
...
| **Cyrillic / Georgian** (Russian, Ukrainian, Bulgarian, and so on.) | Default | Decomposition, lowercase |
...
Using a multilingual embedding model lets you:
