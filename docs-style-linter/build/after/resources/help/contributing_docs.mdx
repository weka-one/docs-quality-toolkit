...
5. Fill in the first field with a short, descriptive title (for example, "Fix typo in search API reference")
...
- Creating written or video content (tutorials, blog posts, and so on.)
