...
- Use the **Default Chat API key** for the [Chats API](/capabilities/agentic_search/advanced/chats_api#find-your-chat-api-key) (can be safely used from the frontend)
