...
Set environment variables before launching the instance:
...
Meilisearch accepts a configuration file in `.toml` format. Configuration files can be easily shared, versioned, and let you define multiple options.
