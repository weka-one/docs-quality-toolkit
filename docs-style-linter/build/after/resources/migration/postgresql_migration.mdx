...
| Language configurations (`english`, `french`, and so on.) | [`localizedAttributes`](/reference/api/settings/update-localizedattributes) | Assign languages to specific fields |
