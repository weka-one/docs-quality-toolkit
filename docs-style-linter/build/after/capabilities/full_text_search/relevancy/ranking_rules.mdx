...
Place custom ranking rules (`popularity:desc`, `release_date:desc`, and so on.) at the end of your sequence. They work best for adding business logic after text relevance has been established.
