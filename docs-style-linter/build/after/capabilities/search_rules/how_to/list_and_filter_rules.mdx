...
- **Scheduled promotions**: list every rule whose conditions contain a `time` scope with a `start` in the future. This is a good consistency check before a campaign goes live.
...
<CardGroup cols={2}>
  ...
  <Card title="API reference" href="/reference/api/search-rules/list-search-rules">
