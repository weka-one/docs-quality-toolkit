...
- You can use [binary quantization](/capabilities/hybrid_search/advanced/binary_quantization) on individual embedders to reduce storage (for example, quantize the large model but keep the small one at full precision).
