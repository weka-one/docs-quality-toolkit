...
Meilisearch uses embedding models for hybrid and semantic search, making it orders of magnitude cheaper and faster than LLM-based approaches. For conversational AI features that do use LLMs, see [agentic search](/capabilities/agentic_search/overview).
...
| TwelveLabs | [Configure TwelveLabs Marengo](/capabilities/hybrid_search/providers/twelvelabs) |
