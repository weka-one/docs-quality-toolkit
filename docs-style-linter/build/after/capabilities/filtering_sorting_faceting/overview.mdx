...
- **Filtering** narrows results to documents matching specific criteria (for example, `genre = "action"`)
- **Sorting** orders results by a field value (for example, price ascending)
