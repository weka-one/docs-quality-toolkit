...
The requested batch does not exist. Ensure that you are using the correct [`uid`](/reference/api/batches/list-batches).
...
The requested task status is invalid. Use one of the [possible values](/reference/api/tasks/get-task).

## `invalid_task_types`

The requested task type is invalid. Use one of the [possible values](/reference/api/tasks/get-task).
...
The requested task uid does not exist. Ensure that you are using the correct `uid`.
